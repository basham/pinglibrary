package org.pingplatform.ping.events {
	...
	public class PingCornerDataEvent extends Event {
		
		public static const SENSOR_CHANGE:String = "onCornerSensorChangeEvent";
		
		private var _index:uint;
		private var _data:PingCornerData;
		
		public function PingCornerDataEvent( type:String, index:uint, data:PingCornerData,
